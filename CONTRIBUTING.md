...
Welcome to `hello12345` contributor's guide.
...
If you experience bugs or general issues with `hello12345`, please have a look
...
You can help improve `hello12345` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hello12345` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hello12345`'s files. While this mechanism can
...
```
conda create -n hello12345 python=3 six virtualenv pytest pytest-cov
conda activate hello12345
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hello12345.git
   cd hello12345
   ```
...
5. Install [pre-commit]:
   ...
   `hello12345` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hello12345
[issue tracker]: https://github.com/<USERNAME>/hello12345/issues
